...
<body>
    ...
    <div class="sidebar-left">
        ...
        <div class="sidebar-content">
            ...
            <p class="text">E-Learning STT-NF ini dibuat khusus untuk mempermudah civitas akademika STT-NF dalam
                melakukan pembelajaraan online atau daring</p>
            <!-- logo -->
            <!-- menu -->
            <div class="sidebar-social align-items-center justify-content-center">
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://www.instagram.com/sttterpadunf/?hl=id" target="_blank"><i
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="header-content">
                        ...
                        <p>
                            Sekolah Tinggi Teknologi Terpadu Nurul Fikri (populer disebut STT-NF) merupakan perguruan
                            tinggi yang memadukan keilmuan praktis di bidang
                            teknologi informasi dengan pengembangan kepribadian islami, kompeten dan berkarakter. Pada
                            tahun 2012, STT-NF resmi berdiri berdasarkan SK Menteri
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-12">
                    <div class="about-five-content">
                        ...
                        <h2 class="main-title fw-bold">Visi, Misi dan Tujuan Sekolah Tinggi Teknologi Terpadu Nurul
                            Fikri</h2>
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <button class="nav-link" id="nav-history-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="nav-history" aria-selected="false">TUJUAN</button>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-who" role="tabpanel"
                                    aria-labelledby="nav-who-tab">
                                    <p>“Pada tahun 2025 menjadi sekolah tinggi teknologi yang unggul di Indonesia,
                                        berbudaya inovasi, berjiwa teknopreneur, dan berkarakter religius.”.</p>
                                </div>
                                <div class="tab-pane fade" id="nav-vision" role="tabpanel"
                                    aria-labelledby="nav-vision-tab">
                                    <p>1. Menyelenggarakan pendidikan tinggi berkualitas yang mengembangkan jiwa
                                        kepemimpinan dan teknopreneurship berlandaskan iman dan takwa.</p>
                                    <p>2. Melaksanakan penelitian yang inovatif dan berorientasi pada pengembangan
                                        teknologi masa depan.</p>
                                    <p>3. Menyelenggarakan pengabdian kepada masyarakat dengan memanfaatkan teknologi
                                        tepat guna.</p>
                                    <p>4. Membangun lingkungan akademik yang kondusif bagi terwujudnya kebebasan
                                        akademik, otonomi keilmuan, dan budaya inovasi.</p>
                                </div>
                                <div class="tab-pane fade" id="nav-history" role="tabpanel"
                                    aria-labelledby="nav-history-tab">
                                    <p>1.Menghasilkan sarjana yang kompeten, profesional, berakhlak mulia, sehingga
                                        mampu berkompetisi di dunia kerja.</p>
                                    <p>2.Menghasilkan karya-karya ilmiah dibidang teknologi informasi berwawasan masa
                                        depan yang inovatif dan bercirikan keterbukaan (openness) seperti open source,
                                        open standar dan open access/content, sehingga bermanfaat bagi bangsa Indonesia
                                        dan diakui secara Internasional.</p>
                                    <p>3.Menerapkan ilmu pengetahuan dan teknologi tepat guna bagi masyarakat dengan
                                        melibatkan sivitas akademika.</p>
                                    <p>4.Menciptakan kultur akademik yang inovatif, kompetitif dan kondusif untuk
                                        mewujudkan institusi yang unggul dan terkemuka.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xl-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-content">
                                        <h4>Address</h4>
                                        <p>Jl. Raya Lenteng Agung <br /> No.20, RT.4/RW.1, <br /> Srengseng Sawah, Kec.
                                            Jagakarsa,<br />Kota Jakarta Selatan, <br />DKI Jakarta 12640</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-xl-12">
    ...
    <section class="map-section map-style-9">
        <div class="map-container">
            <object style="border:0; height: 400px; width: 100%;"
                data="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d350.48791576778956!2d106.832546838348!3d-6.352847839571843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec6b07b68ea5%3A0x17da46bdf9308386!2sSTT%20Terpadu%20Nurul%20Fikri%20-%20Kampus%20B!5e0!3m2!1sid!2sid!4v1654671609993!5m2!1sid!2sid"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="footer-widget f-about">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="<?php echo base_url('assets/sttnf-logo.png') ?>" alt="#"
                                            class="img-fluid" width="200px" height="50px" />
                                    </a>
                                </div>
                                <p>
                                    Kuliah? STT-NF Aja
                                ...
                                <p class="copyright-text">
                                    ...
                                    <a href="https://www.instagram.com/ridhostwn22/" rel="nofollow"> Ridho Setiawan </a>
                                </p>
                            </div>
                            <!-- End Single Widget -->
                        </div>
                        <div class="col-lg-2 col-md-6 col-12">
                            ...
                            <div class="footer-widget f-link">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://ais.nurulfikri.ac.id/welcome" target="_blank">Sistem
                                            Akademik</a></li>
                        ...
                        <div class="col-lg-2 col-md-6 col-12">
                            ...
                            <div class="footer-widget f-link">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://slibc.nurulfikri.ac.id/" target="_blank">Inkubator Bisnis</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- End Single Widget -->
